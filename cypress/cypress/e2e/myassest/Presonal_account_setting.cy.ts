...
import MyassetsFunction from "../../../../cypress/e2e/pages/myassets_function"
describe("Pressonal account settings", () => {
    ...
    context('Edit Profile', () => {
        ...
        it('Edit Profile button', () => {
            cy.get('.jss937 > .MuiBox-root > .MuiButtonBase-root').click('center')
            cy.get('.MuiTypography-root > :nth-child(1) > .MuiGrid-container').should('exist')
        })
        it('Edit Profile - Name', () => {
            ...
            cy.reload()
            cy.get('.jss80 > :nth-child(1) > .MuiTypography-root').should('exist').contains('name')
        ...
        it('Edit profile - Phone Number', () => {
            ...
            cy.get('.jss1060').click('center')
            cy.reload()
            cy.get(':nth-child(3) > .MuiBox-root > .jss83').should('exist').contains('0909090000')
        })
    ...
    context('Edit Perferemces', () => {
        ...
        it('Base Currency update', () => {
            ...
            cy.get(':nth-child(2) > :nth-child(1) > .MuiBox-root > .jss957').should('exist').contains('BMD')
